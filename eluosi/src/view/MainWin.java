...
public MainWin(Opration opration, GameData gameDate){
    ...
    setBounds(100,50,360,600);//50分别是距离左上角的左侧和左上角的上侧的距离，左到右是360px，上到下是600px
    ...
    private void srtScoreNext() {
        scoreNext = new ScoreNext(gameDate);
 ...
 */
    ...
    */ 
    void setBack(){
        ...
        j1.setBounds(0,0,360,600);//给图片相对于窗口的大小并设置图片大小
